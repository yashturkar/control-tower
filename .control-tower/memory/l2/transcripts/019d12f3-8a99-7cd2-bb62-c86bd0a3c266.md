...
```json
{
  ...
  "packet_type": "task",
  "packet_id": "09f92dc8-2796-4097-b923-e0cd3f12e5cd",
  "trace_id": "717159b8-14b6-4b18-bbb1-cd954125645d",
  "parent_packet_id": null,
  "created_at": "2026-03-22T00:30:39Z",
  "from_agent": "tower",
  "to_agent": "scribe",
  ...
  "inputs": {
    "files": [
      ".control-tower/memory/l2/sessions/019d12f2-6cf3-7631-b544-c55013580eaa.jsonl"
    ],
    "artifacts": [],
    "references": []
  },
  ...
  "allow_partial": true,
  "metadata": {
    "generated_by": "tower sync-memory"
  }
}
```
